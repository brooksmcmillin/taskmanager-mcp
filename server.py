...
class ResourceServerSettings(BaseSettings):
    ...
    # Server settings
    server_url: AnyHttpUrl = AnyHttpUrl("https://mcp.ROOT_DOMAIN")

    host: str = "https://mcp.ROOT_DOMAIN"
    port: int = 443

    # Authorization Server settings
    auth_server_url: AnyHttpUrl = AnyHttpUrl("https://mcp-auth.ROOT_DOMAIN")
    auth_server_introspection_endpoint: str = "https://mcp-auth.ROOT_DOMAIN/introspect"
...
@click.option("--auth-server", default="https://mcp-auth.ROOT_DOMAIN", help="Authorization Server URL")
