...
def create_resource_server(
    ...
    @app.tool()
    async def create_project(name: str, color: str, description: str | None = None) -> str:
        response = get_api_client().create_project(name, color, description)
        return json.dumps(response.data)

    @app.tool()
    async def update_project(project_id: int, name: str | None = None, color: str | None = None, description: str | None = None) -> str:
        response = get_api_client().update_project(project_id, name, color, description)
        return json.dumps(response.data)
    ...
    async def update_task(
        ...
        response = get_api_client().update_todo(task_id, title=title, project_id=project_id, description=description, priority=priority, due_date=due_date)
        return json.dumps(response.data)
